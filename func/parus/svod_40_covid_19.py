...
def svod_40_covid_19():
    ...
    sql_08 = open('func/parus/sql/covid_40_revac_old_new.sql','r').read()
    sql_09 = open('func/parus/sql/covid_40_light.sql','r').read()
    sql_10 = open('func/parus/sql/covid_40_light_old.sql','r').read()
