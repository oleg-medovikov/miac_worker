...
def svod_50_covid_19():
    SQL_1 = open('func/parus/sql/covid_50_polic.sql', 'r').read()
    SQL_2 = open('func/parus/sql/covid_50_stac.sql', 'r').read()
    SQL_3 = open('func/parus/sql/mz_50.sql', 'r').read()

    SQL_4 = open('func/parus/sql/covid_50_polic_old.sql', 'r').read()
    SQL_5 = open('func/parus/sql/covid_50_stac_old.sql', 'r').read()
