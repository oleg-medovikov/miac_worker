...
def report_vp_and_cv():
    ...
    HEADER = ['vp_03_Power_Count_Departments','vp_04_Power_Count_Allocated_All',
            ...
            'cv_23_Power_Count_Reanimation','cv_24_Hospital_All','cv_25_Hospital_Day',
            'cv_26_Hospital_Hard_All','cv_27_Hospital_Hard_Reaniamation',
            'cv_28_Hospital_Hard_Ivl','cv_29_ReceivedAll','cv_30_ReceivedDay',
            'cv_31_DischargedAll','cv_32_DischargedDay','cv_33_DiedAll',
            'cv_34_DiedDay','nameMO']
    ...
    if check_data_table('mon_vp.v_DebtorsReport'):
        TABLE = covid_sql("""SELECT [Наименование МО] as 'должники!'
    ...
    df1 = df.loc[df.typeMO==1].sort_values(["numSort"])\
            .drop('typeMO',1)\
            .drop('numSort',1)
    
    df2 = df.loc[df.typeMO==2].sort_values(["numSort"])\
            .drop('typeMO',1)\
            .drop('numSort',1)
