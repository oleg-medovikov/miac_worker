SELECT 'Медицинская организация' AS tip, 1 AS INDX,  ORGANIZATION, DAY,'Всего' as typevacine, concat(ORGANIZATION, DAY, ' Всего') AS scep
...
UNION all
SELECT  'Медицинская организация' AS tip ,2 AS INDX, ORGANIZATION, DAY,'Гам-КОВИД-Вак (Спутник-V)' as  typevacine, concat(ORGANIZATION, DAY, ' Гам-КОВИД-Вак (Спутник-V)') AS scep
		,nvl(cast(cov_02 as int),0) cov_02
		,nvl(cast(cov_03 as int),0) cov_03,nvl(cast(cov_04 as int),0) cov_04
		,nvl(cast(cov_05 as int),0) cov_05,nvl(cast(cov_06 as int),0) cov_06
		,nvl(cast(cov_07 as int),0) cov_07,nvl(cast(cov_08 as int),0) cov_08
...
UNION ALL
SELECT  'Медицинская организация' AS tip ,3 AS INDX,ORGANIZATION, DAY,'КовиВак' as typevacine, concat(ORGANIZATION, DAY, ' КовиВак') AS scep
		,nvl(cast(cov_02 as int),0) cov_02
		,nvl(cast(cov_03 as int),0) cov_03,nvl(cast(cov_04 as int),0) cov_04
		,nvl(cast(cov_05 as int),0) cov_05,nvl(cast(cov_06 as int),0) cov_06
		,nvl(cast(cov_07 as int),0) cov_07,nvl(cast(cov_08 as int),0) cov_08
...
UNION ALL 
SELECT 'Медицинская организация' AS tip, 4 AS INDX,ORGANIZATION, DAY,'ЭпиВакКорона' as typevacine, concat(ORGANIZATION, DAY, ' ЭпиВакКорона') AS scep
		,nvl(cast(cov_02 as int),0) cov_02
		,nvl(cast(cov_03 as int),0) cov_03,nvl(cast(cov_04 as int),0) cov_04
		,nvl(cast(cov_05 as int),0) cov_05,nvl(cast(cov_06 as int),0) cov_06
		,nvl(cast(cov_07 as int),0) cov_07,nvl(cast(cov_08 as int),0) cov_08
...
UNION ALL 
SELECT  'Медицинская организация' AS tip , 5 AS INDX,ORGANIZATION, DAY,'Спутник Лайт' as typevacine, concat(ORGANIZATION, DAY, ' Спутник Лайт') AS scep
		,nvl(cast(cov_02 as int),0) cov_02
		,nvl(cast(cov_03 as int),0) cov_03,nvl(cast(cov_04 as int),0) cov_04
		,nvl(cast(cov_05 as int),0) cov_05,nvl(cast(cov_06 as int),0) cov_06
		,nvl(cast(cov_07 as int),0) cov_07,nvl(cast(cov_08 as int),0) cov_08
...
UNION ALL 
SELECT  'Пункт вакцинации' AS tip, 6 AS INDX, ORGANIZATION, DAY, revac as typevacine
		...
		,nvl(cast(cov_15 as int),0) cov_15,nvl(cast(cov_16 as int),0) cov_16
		,nvl(cast(cov_17 as int),0) cov_17,nvl(cast(cov_18 as int),0) cov_18
		,nvl(cast(cov_19 as int),0) cov_19 --,nvl(cast(cov_20 as int),0) cov_20
		FROM (
        SELECT
			to_char(r.BDATE, 'DD.MM.YYYY') day,
                a.AGNNAME organization,
