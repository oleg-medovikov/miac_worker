SELECT 1 AS INDX, ORGANIZATION, DAY,'Всего' as typevacine, concat(ORGANIZATION, DAY, ' Всего') AS scep
...
UNION all
SELECT 2 AS INDX, ORGANIZATION, DAY,'Гам-КОВИД-Вак (Спутник-V)' as  typevacine, concat(ORGANIZATION, DAY, ' Гам-КОВИД-Вак (Спутник-V)') AS scep
		,nvl(cast(cov_02 as int),0) cov_02
		,nvl(cast(cov_03 as int),0) cov_03,nvl(cast(cov_04 as int),0) cov_04
		,nvl(cast(cov_05 as int),0) cov_05,nvl(cast(cov_06 as int),0) cov_06
		,nvl(cast(cov_07 as int),0) cov_07,nvl(cast(cov_08 as int),0) cov_08
...
UNION ALL
SELECT 3 AS INDX,ORGANIZATION, DAY,'КовиВак' as typevacine, concat(ORGANIZATION, DAY, ' КовиВак') AS scep
		,nvl(cast(cov_02 as int),0) cov_02
		,nvl(cast(cov_03 as int),0) cov_03,nvl(cast(cov_04 as int),0) cov_04
		,nvl(cast(cov_05 as int),0) cov_05,nvl(cast(cov_06 as int),0) cov_06
		,nvl(cast(cov_07 as int),0) cov_07,nvl(cast(cov_08 as int),0) cov_08
...
UNION ALL 
SELECT 4 AS INDX,ORGANIZATION, DAY,'ЭпиВакКорона' as typevacine, concat(ORGANIZATION, DAY, ' ЭпиВакКорона') AS scep
		,nvl(cast(cov_02 as int),0) cov_02
		,nvl(cast(cov_03 as int),0) cov_03,nvl(cast(cov_04 as int),0) cov_04
		,nvl(cast(cov_05 as int),0) cov_05,nvl(cast(cov_06 as int),0) cov_06
		,nvl(cast(cov_07 as int),0) cov_07,nvl(cast(cov_08 as int),0) cov_08
...
UNION ALL 
SELECT 5 AS INDX, ORGANIZATION, DAY,'Спутник Лайт' as typevacine, concat(ORGANIZATION, DAY, ' Спутник Лайт') AS scep
		,nvl(cast(cov_02 as int),0) cov_02
		,nvl(cast(cov_03 as int),0) cov_03,nvl(cast(cov_04 as int),0) cov_04
		,nvl(cast(cov_05 as int),0) cov_05,nvl(cast(cov_06 as int),0) cov_06
		,nvl(cast(cov_07 as int),0) cov_07,nvl(cast(cov_08 as int),0) cov_08
