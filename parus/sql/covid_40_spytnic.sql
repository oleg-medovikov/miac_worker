SELECT  ORGANIZATION, 'Пункт вакцинации' type, 
                substr(ii.Vaccin_TVSP ,1,INSTR(ii.Vaccin_TVSP , ' ')-1) dist,
        ...
        FROM (
                ...
                (
                max(value)
                FOR POKAZATEL IN ('Vaccin_tvsp_03' Vaccin_tvsp_03,'Vaccin_tvsp_04' Vaccin_tvsp_04,'Vaccin_tvsp_04_day' Vaccin_tvsp_04_day,
                                                ...
                                                'Vaccin_tvsp_21' Vaccin_tvsp_21, 'Vaccin_tvsp_21_day' Vaccin_tvsp_21_day)
...
SELECT  ORGANIZATION,	'Медицинская организация' type, 
                ...
                WHERE rf.code = '40 COVID 19'
                 and  r.BDATE =  trunc(SYSDATE) - 1
                and bi.CODE in ('Vaccin_MO','Vaccin_DISTR','Vaccin_03','Vaccin_04','Vaccin_04_day','Vaccin_05',
                ...
                (
                max(value)
                FOR POKAZATEL IN ('Vaccin_MO' MO,'Vaccin_DISTR' dist,'Vaccin_03' Vaccin_03,'Vaccin_04' Vaccin_04,'Vaccin_04_day' Vaccin_04_day,
