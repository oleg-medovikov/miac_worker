SELECT  ORGANIZATION, 'Пункт вакцинации' type,substr(ii.Vaccin_TVSP ,1,INSTR(ii.Vaccin_TVSP , ' ')-1) dist,
                TRIM(LEADING ' ' from REPLACE(substr(ii.Vaccin_TVSP ,INSTR(ii.Vaccin_TVSP , ' ')+1, length(ii.Vaccin_TVSP)),'район ','') ) Vaccin_TVSP,
                ...
                CAST(Vaccin_tvsp_22 AS int) Vaccin_tvsp_22,CAST(revac_20_01 AS int) revac_20_01
        FROM (
                SELECT
                ...
                and i.CODE in (
                    'Vaccin_TVSP', 'Vaccin_tvsp_03', 'Vaccin_tvsp_04', 'Vaccin_tvsp_04_day', 'Vaccin_tvsp_05',
                ...
                max(value)
                FOR POKAZATEL IN (
                    'Vaccin_tvsp_03' Vaccin_tvsp_03,'Vaccin_tvsp_04' Vaccin_tvsp_04,
                    'Vaccin_tvsp_04_day' Vaccin_tvsp_04_day,'Vaccin_tvsp_05' Vaccin_tvsp_05,
                    'Vaccin_tvsp_06' Vaccin_tvsp_06,'Vaccin_tvsp_07' Vaccin_tvsp_07,
                    'Vaccin_tvsp_08' Vaccin_tvsp_08,'Vaccin_tvsp_09' Vaccin_tvsp_09,
                    'Vaccin_tvsp_10' Vaccin_tvsp_10,'Vaccin_tvsp_11' Vaccin_tvsp_11,
                    'Vaccin_tvsp_12' Vaccin_tvsp_12, 'Vaccin_tvsp_20' Vaccin_tvsp_20,
                    'Vaccin_tvsp_20_day' Vaccin_tvsp_20_day,'Vaccin_tvsp_13' Vaccin_tvsp_13,
                    'Vaccin_tvsp_14' Vaccin_tvsp_14,'Vaccin_tvsp_15' Vaccin_tvsp_15,
                    'Vaccin_tvsp_16' Vaccin_tvsp_16, 'Vaccin_tvsp_17' Vaccin_tvsp_17,
                    'Vaccin_tvsp_18' Vaccin_tvsp_18, 'Vaccin_tvsp_19' Vaccin_tvsp_19,
                    'Vaccin_tvsp_19_day' Vaccin_tvsp_19_day,'Vaccin_tvsp_21' Vaccin_tvsp_21,
                    'Vaccin_tvsp_21_day' Vaccin_tvsp_21_day, 'Vaccin_tvsp_22' Vaccin_tvsp_22
                    )
...
UNION
    SELECT  ORGANIZATION, 'Медицинская организация' type, REPLACE(dist,' район ','') dist,MO,
    ...
    CAST(Vaccin_22 AS int) Vaccin_22,CAST(revac_20_02 AS int) revac_20_02
                FROM (
                SELECT
                        to_char(r.BDATE, 'DD.MM.YYYY') day,
                        a.AGNNAME ORGANIZATION ,
                ...
                WHERE rf.code = '40 COVID 19'
                 and  r.BDATE =  trunc(SYSDATE) - 1
                and bi.CODE in (
                    'Vaccin_MO','Vaccin_DISTR','Vaccin_03','Vaccin_04',
                    'Vaccin_04_day','Vaccin_05','Vaccin_06','Vaccin_07',
                    'Vaccin_08', 'Vaccin_09', 'Vaccin_10','Vaccin_11',
                    'Vaccin_12', 'Vaccin_20','Vaccin_20_day','Vaccin_13',
                    'Vaccin_14','Vaccin_15', 'Vaccin_16', 'Vaccin_17',
                    'Vaccin_18', 'Vaccin_19', 'Vaccin_19_day','Vaccin_21',
                    'Vaccin_21_day', 'Vaccin_22', 'revac_20_02_s')
                )
                pivot
                (
                max(value)
                FOR POKAZATEL IN (
                    'Vaccin_MO' MO,'Vaccin_DISTR' dist,
                    'Vaccin_03' Vaccin_03,'Vaccin_04' Vaccin_04,
                    'Vaccin_04_day' Vaccin_04_day,'Vaccin_05' Vaccin_05,
                    'Vaccin_06' Vaccin_06,'Vaccin_07' Vaccin_07,
                    'Vaccin_08' Vaccin_08, 'Vaccin_09' Vaccin_09,
                    'Vaccin_10' Vaccin_10,'Vaccin_11' Vaccin_11,
                    'Vaccin_12' Vaccin_12, 'Vaccin_20' Vaccin_20,
                    'Vaccin_20_day' Vaccin_20_day,'Vaccin_13' Vaccin_13,
                    'Vaccin_14' Vaccin_14,'Vaccin_15' Vaccin_15,
                    'Vaccin_16' Vaccin_16, 'Vaccin_17' Vaccin_17,
                    'Vaccin_18' Vaccin_18, 'Vaccin_19' Vaccin_19,
                    'Vaccin_19_day' Vaccin_19_day,'Vaccin_21' Vaccin_21,
                    'Vaccin_21_day' Vaccin_21_day,'Vaccin_22' Vaccin_22,
                    'revac_20_02_s' revac_20_02
                    ))
