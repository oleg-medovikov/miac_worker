SELECT ORGANIZATION, 'Пункт вакцинации' type,  substr(KV_TVSP_02 ,1,INSTR(KV_TVSP_02 , ' ')-1) dist,
        ...
        nvl(cast(KV_TVSP_26 as int),0), nvl(cast(revac_20_01 as int),0)  revac_20_01
                FROM (
                SELECT
                ...
                and i.CODE in (
                    'KV_TVSP_02','KV_TVSP_04','KV_TVSP_05_z',
                    ...
                    'KV_TVSP_19_z', 'KV_TVSP_20', 'KV_TVSP_21',
                    'KV_TVSP_22','KV_TVSP_23_z', 'KV_TVSP_24',
                    'KV_TVSP_25_z', 'KV_TVSP_26'
                    )
                )
                pivot
                (
                max(value)
                FOR POKAZATEL IN (
                    'KV_TVSP_02'  KV_TVSP_02, 'KV_TVSP_04'  KV_TVSP_04,
                    'KV_TVSP_05_z'  KV_TVSP_05_z,'KV_TVSP_06'  KV_TVSP_06,
                    'KV_TVSP_07_z'  KV_TVSP_07_z,'KV_TVSP_08'  KV_TVSP_08,
                    'KV_TVSP_09_z'  KV_TVSP_09_z,'KV_TVSP_10'  KV_TVSP_10,
                    'KV_TVSP_11_z'  KV_TVSP_11_z,'KV_TVSP_12'  KV_TVSP_12,
                    'KV_TVSP_13_z'  KV_TVSP_13_z,'KV_TVSP_14'  KV_TVSP_14,
                    'KV_TVSP_15_z'  KV_TVSP_15_z,'KV_TVSP_16'  KV_TVSP_16,
                    'KV_TVSP_17_z'  KV_TVSP_17_z,'KV_TVSP_18'  KV_TVSP_18,
                    'KV_TVSP_19_z'  KV_TVSP_19_z,'KV_TVSP_20'  KV_TVSP_20,
                    'KV_TVSP_21'  KV_TVSP_21, 'KV_TVSP_22'  KV_TVSP_22,
                    'KV_TVSP_23_z'  KV_TVSP_23_z,'KV_TVSP_24'  KV_TVSP_24,
                    'KV_TVSP_25_z'  KV_TVSP_25, 'KV_TVSP_26'  KV_TVSP_26)
...
UNION
        ...
        nvl(cast(epy_vak_26 as int),0)  epy_vak_26,nvl(cast(revac_20_03 as int),0)  revac_20_03
                FROM (
                SELECT
                to_char(r.BDATE, 'DD.MM.YYYY') day,
                        a.AGNNAME ORGANIZATION ,
                ...
                WHERE rf.code = '40 COVID 19'
                 and  r.BDATE =  trunc(SYSDATE) - 1
                 and bi.CODE in (
                    'epy_vak_01','epy_vak_02','epy_vak_04','epy_vak_05_z',
                    'epy_vak_06','epy_vak_07_z', 'epy_vak_08', 'epy_vak_09_z',
                    'epy_vak_10', 'epy_vak_11_z','epy_vak_12','epy_vak_13_z',
                    'epy_vak_14', 'epy_vak_15_z', 'epy_vak_16','epy_vak_17_z',
                    'epy_vak_18','epy_vak_19_z', 'epy_vak_20', 'epy_vak_21',
                    'epy_vak_22', 'epy_vak_23_z', 'epy_vak_24', 'epy_vak_25_z',
                    'epy_vak_26', 'revac_20_03_s'
                    )
                )
                pivot
                (
                max(value)
                FOR POKAZATEL IN (
                    'epy_vak_01'  epy_vak_01,'epy_vak_02'  epy_vak_02,
                    'epy_vak_04'  epy_vak_04,'epy_vak_05_z'  epy_vak_05_z,
                    'epy_vak_06'  epy_vak_06,'epy_vak_07_z'  epy_vak_07_z,
                    'epy_vak_08'  epy_vak_08,'epy_vak_09_z'  epy_vak_09_z,
                    'epy_vak_10'  epy_vak_10,'epy_vak_11_z'  epy_vak_11_z,
                    'epy_vak_12'  epy_vak_12,'epy_vak_13_z'  epy_vak_13_z,
                    'epy_vak_14'  epy_vak_14,'epy_vak_15_z'  epy_vak_15_z,
                    'epy_vak_16'  epy_vak_16,'epy_vak_17_z'  epy_vak_17_z,
                    'epy_vak_18'  epy_vak_18,'epy_vak_19_z'  epy_vak_19_z,
                    'epy_vak_20'  epy_vak_20,'epy_vak_21'  epy_vak_21,
                    'epy_vak_22'  epy_vak_22,'epy_vak_23_z'  epy_vak_23_z,
                    'epy_vak_24'  epy_vak_24,'epy_vak_25_z'  epy_vak_25,
                    'epy_vak_26'  epy_vak_26,'revac_20_03_s'  revac_20_03
        )
