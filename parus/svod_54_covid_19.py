...
COLUMNS = [
    'exp_test_01_01', 'exp_test_02_01', 'exp_test_03_01', 'exp_test_04_01',
    'exp_test_05_01', 'exp_test_06_01', 'exp_test_07_01', 'exp_test_08_01',
    'exp_test_09_01'
]

DICT_ORGS = {
    'СПб ГБУЗ "Городская поликлиника №22"': '15.05.2023',
    'СПб ГБУЗ "Городская поликлиника №71"': '15.05.2023',
    'СПб ГБУЗ "Городская поликлиника №107"': '15.05.2023',
    'СПб ГБУЗ "Городская поликлиника №120"': '15.05.2023',
    'СПб ГБУЗ "Городская поликлиника №17"': '15.05.2023',
    'СПб ГБУЗ "Городская поликлиника №91"': '15.05.2023',
    'СПб ГБУЗ "Городская больница №15"': '15.05.2023',
    'СПб ГБУЗ ГЦОРЗП "Ювента"': '15.05.2023',
    'СПБ ГБУЗ "ССМП"': '15.05.2023',
}
...
def svod_54_covid_19():
    ...
    for NOMER in PART_NOMER:
        ...
        PART = PART.pivot_table(
            index=['ORGANIZATION', 'DAY'],
            columns=['POKAZATEL'],
            aggfunc='first'
            ).stack(0)
