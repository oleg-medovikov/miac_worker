...
DICT_ORGS = {
    ...
    'ОБЩЕСТВО С ОГРАНИЧЕННОЙ ОТВЕТСТВЕННОСТЬЮ "МЕДИЦИНСКИЙ ЦЕНТР ЭКО- БЕЗОПАСНОСТЬ"': '19.04.2023',
    'ООО «Евромед Клиник»': '19.04.2023',
    'ООО «ЭкоМед»': '19.04.2023',
    'ООО "Клиника АйДи"': '19.04.2023',
    'ООО "АЗИМУТ-МЕД"': '14.05.2023',
        }
